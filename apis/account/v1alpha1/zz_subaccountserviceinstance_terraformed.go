...
func (mg *SubaccountServiceInstance) GetTerraformResourceType() string {
	return "btp_subaccount_service_instance"
}
...
// LateInitialize this SubaccountServiceInstance using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SubaccountServiceInstance) LateInitialize(attrs []byte) (bool, error) {
	params := &SubaccountServiceInstanceParameters{}
